  ...
  const handlePayAtService = async () => {
    ...
    try {
      ...
      const directPayload = {
        ...
        timeSlot: bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        time_slot: bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        timeslot: bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        slot: bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        time: bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        TimeSlot: bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        'Time Slot': bookingDetails?.timeSlot || bookingDetails?.time_slot || bookingDetails?.timeslot || bookingDetails?.slot || bookingDetails?.time || '09:00 AM - 11:00 AM',
        bikeModel: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        bike_model: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        bikemodel: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        bike: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        model: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        vehicle: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        vehicleModel: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        vehicle_model: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        Vehicle: bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        'Vehicle Model': bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        'Bike Model': bookingDetails?.bikeModel || bookingDetails?.bike_model || bookingDetails?.bikemodel || bookingDetails?.bike || bookingDetails?.vehicle || bookingDetails?.vehicleModel || bookingDetails?.model || 'Bike Service',
        service: displayService,
        plan: planName,
        'Plan': planName,
        amount: displayTotal,
            ...
            if (!item._synced) {
              try {
                ...
                const payload = {
                  ...
                  timeSlot: item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  time_slot: item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  timeslot: item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  slot: item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  time: item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  TimeSlot: item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  'Time Slot': item.timeSlot || item.time_slot || item.timeslot || item.slot || item.time || '09:00 AM - 11:00 AM',
                  bikeModel: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  bike_model: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  bikemodel: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  bike: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  model: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  vehicle: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  vehicleModel: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  vehicle_model: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  Vehicle: item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  'Vehicle Model': item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
                  'Bike Model': item.bikeModel || item.bike_model || item.bikemodel || item.bike || item.vehicle || item.vehicleModel || item.model || 'Bike Service',
